...
namespace InvitationPlatform.Infrastructure.Migrations
{
    ...
    [Migration("20260809121215_AddDemoRequestReadAt")]
    partial class AddDemoRequestReadAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvitationPlatform.Domain.Entities.ClientAccount", b =>
                {
                    ...
                    b.ToTable("client_accounts", null, t =>
                        {
                            t.HasCheckConstraint("CK_client_accounts_contact", "email IS NOT NULL OR phone IS NOT NULL");
                        });
                });

            modelBuilder.Entity("InvitationPlatform.Domain.Entities.DemoRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("InvitationPlatform.Domain.Entities.UserMedia", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("InvitationId", "ContentHash")
                        .IsUnique();
